...
def create_subparser_check_checksum(subparsers):
    ...
    parser.add_argument(
        ...
        required=True,
        dest='directories',
        help='Check hashes for this directory tree or these directory trees. Symbolic links in given directories are ignored. All hash files and data files have to be in this directory tree or these directory trees.',
        metavar='dir')
    parser.add_argument(
        '-hash_extension',
        nargs="+",
    ...
    parser.add_argument(
        ...
        help='Files with the given extension(s) are ignored. default: ~ .tmp .bak',
        metavar='ext')
    parser.add_argument(
        '-buf_size',
        nargs=1,
